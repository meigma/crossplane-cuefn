...
import (
	...
	"github.com/meigma/crossplane-cuefn/internal/config"
)
...
func NewRootCommand(options Options) *cobra.Command {
	...
	root := &cobra.Command{
		Use:           "cuefn",
		Short:         "CUE-over-OCI Crossplane composition tooling",
	...
	// build registers nothing so the runtime binary omits internal/pkg's heavy
	// dependency graph. See packaging.go.
	addPackagingCommands(root, options)
	return root
}
