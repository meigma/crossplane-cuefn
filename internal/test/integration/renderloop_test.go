...
// TestRenderLoop_CrossplaneRender proves the full v2 render loop: the hermetic
// fixture module is served from a local OCI registry, `cuefn function --insecure`
